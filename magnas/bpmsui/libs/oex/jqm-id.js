    ...
    return {
        init: function (element, valueAccessor, allBindings) {
            ...
            var updateList = function () {
                var ul = $element.closest("[data-bind]").find("ul");
                var lis = "";
                if (items.length) {
...
/*                             "<span class=\"ui-body-inherit\">" + item.name + "</span>" +
                            "<span class=\"ui-li-count ui-body-inherit\">" + item.id + "</span>";  */
							"<span class=\"ui-body-inherit\">" + item.id + "</span>" +
                            "<span class=\"ui-li-count ui-body-inherit\">" + item.name + "</span>";
                    ...
                    ul.find("li").click(function (e) {
                        ...
                        var key = li.find("span").eq(0).html();
                        var name = li.find("span").eq(1).html();
                        var selectedText = "";
                        var selectedValue = "";
                        selectedText = name;
                        selectedValue = key;
                        ...
                        var clearBtn = $element.parent().find("a.ui-input-clear").not(".ui-input-clear-hidden");
            ...
            var _onKeyUp = function (event) {
                ...
                if (text) {
                    var option = {
                        ...
                        order: "desc",
                        start: 0,
                        startableByUser: BPMS.Services.Utils.getUser().userId,
                        suspended: false,
                        nameLike: "%" + text + "%"
                    };
