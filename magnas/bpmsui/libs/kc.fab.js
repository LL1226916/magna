    ...
    $.kc.fab = function (el, links, options) {
        ...
        base.init = function () {
            ...
            if (base.links.length > 0) {
                ...
                main_btn_dom = "<button data-role='none' data-link-href='" + ((main_btn.url) ? main_btn.url : "") + "' data-link-target='" + ((main_btn.target) ? main_btn.target : "") + "' class='kc_fab_main_btn' style='" + bg_color_style + "'><span style='" + color_style + "'>" + main_btn.icon + "</span></button>";
                ...
                for (var i = 0; i < base.links.length; i++) {
                    ...
                    var hasLink = base.links[i].url && typeof (base.links[i].url) === "string";
                    var href = hasLink ? base.links[i].url : "";
                    var bind = base.links[i].bind || "";
                    sub_fab_btns_dom += "<div><button data-role='none' " + id_elem + " data-link-title='" + base.links[i].title + "' data-bind='" + bind + "' data-link-href='" + href + "' data-link-target='" + ((base.links[i].target) ? base.links[i].target : "") + "' class='sub_fab_btn' style='" + bg_color_style + "'><span style='" + color_style + "'>" + base.links[i].icon + "</span></button></div>";
                };
            ...
            main_fab_btn.on("mousedown", function (e) {
