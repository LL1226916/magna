(function (BPMS, $, ko, moment) {
    ...
    //登录页面viewmodel
    BPMS.ViewModels.TagPrintViewModel = function () {
        var root = this;
        window.vm = root;
        ...
        this.searchMaterial = function () {
            ...
            BPMS.Services.getPurchaseOrder(this.material.orderNumber(),
                this.material.lineNumber(),
                this.material.materialNumber()).then(
                    function (items) {
    ...
    BPMS.ViewModels.TagPrintViewModel.extend(BPMS.ViewModels.BaseViewModel);
    BPMS.ViewModels.TagPrintViewModel.prototype.switchTab = function (vm, e) {
        var a = $(e.target).closest("a");
        var tempType = a.attr("id").replace("-tab", "");
        this.type(tempType);
    };

    BPMS.ViewModels.TagPrintViewModel.prototype.init = function () {
        var root = this;
        this.clearHash();
