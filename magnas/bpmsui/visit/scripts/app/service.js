(function (entrance) {
    entrance.service = {
        ...
        getSuggestion: function (keyword) {
            ...
            //};
            //return $.ajax(settings);
            var filters = [{ "type": "category", "target": ["variable", ["template-tag", "intervieweeName"]], "value": keyword }];
            var param = { parameters: JSON.stringify(filters) }
            var settings = {
                dataType: "json",
                url: entrance.config.interviewsInfoUrl + "?" + $.param(param)
            };
        ...
        postFormData: function (data) {
            var url = entrance.config.bpmsServiceUrl + "bpms-rest/service/form/form-data";
            var settings = {
                dataType: "json",
                type: "POST",
                url: url,
                ...
                headers: {
                    ...
                    "Authorization": "Basic aW5mby5tdHQ6UGFzczQzMjE="
                },
