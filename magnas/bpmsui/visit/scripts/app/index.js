(function ($, ko, entrance) {
    var IndexViewModel = function () {
        ...
        this.keyword = ko.observable( "" || BPMS.Services.Utils.getUrlParam(url, "tel"));//13621980587
        ...
        this.save = function () {
            ...
            var accompany = that.options[7].value();
            if (accompany === "有") {
                var accompanyValues = [];
                var accompanyType = that.options[8].value();
                if (accompanyType) {
                    accompanyValues.push.apply(accompanyValues, accompanyType.split(","));
                }
                var accompanyText = (that.options[9].value() || "").trim();
                if (accompanyText) {
            ...
            var data = {
                ...
                properties: [
                    ...
                    { id: "remark_备注_9_string_t1_$$A", value: that.options[10].value() },
					...
					{ id: "intervieweeWechatCode_受访人微信号_6_string_t1_$$B", value: interviewee.intervieweeWechatCode },
                    { id: "attachment_附件_1_string_t9i_$$F", value: that.options[6].value() }]
            };
