ko.bindingHandlers.basicField = {
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        ...
        var controlHtml = {
            ...
            't2': '<textarea rows="4" maxlength="200" style="overflow-y: scroll;" control-type="t2" data-autogrow="false"></textarea>',
            ...
            't9i': '<input style="font-weight:600; height: 38px;  font-size:medium;" data-inline="true" control-type="t9i" data-clear-btn="true" type="file" capture="camera" accept="image/*"/>' +
            ...
            "psbi": '<form class="ui-filterable" autocomplete="off" onsubmit="function(){return false;}">' +
                '<input data-clear-btn="false" style="height:38px;" data-type="search">' +
                '</form>' +
            ...
            "auto": '<div onsubmit="return false;" novalidate class="ui-filterable" autocomplete="off">' +
                '<input style="height:39px; font-weight:600" data-type="search">' +
                '</div>' +
        ...
        var label = '<label><font size="-1" color="#546e7a"></font></label>';
        ...
        var title = valueUnwrapped.name + (valueUnwrapped.required ? " <font size=\"-1\" color=\"#f44336\"><i class=\"fad fa-fw fa-asterisk\"></i></font>" : "");
    ...
    init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
        if (!$("#basicField").length) {
            var template = "<script type=\"text/html\" id=\"basicField\">" +
                ...
                "<label><font color=\"#546e7a\" size=\"-1\"></font></label>" +
                "</form>" +
                "</script>";
